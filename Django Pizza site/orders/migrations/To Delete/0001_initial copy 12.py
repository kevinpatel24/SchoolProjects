# Generated by Django 2.2.7 on 2019-11-21 05:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maxAddOns', models.IntegerField(validators=[django.core.validators.MaxValueValidator(10), django.core.validators.MinValueValidator(0)])),
                ('addOnCount', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='orders.AddOnCount')),
        ...
        migrations.AddField(
            ...
            name='addOnType',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='orders.AddOnType'),
        ),
        migrations.AddField(
            model_name='addoncount',
            name='category',
